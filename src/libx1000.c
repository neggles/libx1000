...
typedef void *(*lmremap_t)(void *start, size_t old_len, size_t len, int flags, void *newaddr);
typedef void *(*lmmap_t)(void *addr, size_t length, int prot, int flags, int fd, off_t offset);
typedef void *(*lmmap64_t)(void *addr, size_t length, int prot, int flags, int fd, __off64_t offset);
